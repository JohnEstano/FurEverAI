  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Hero Image */}
        <div className="mb-16 bg-emerald-500 rounded-xl">
          <div 
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="border-l-4 border-blue-600 pl-4">
              <h4 className="text-xl font-bold text-gray-900 mb-2">Active Adventurer</h4>
              <p className="text-gray-700">High energy, experienced, and needs an active pet.</p>
            </div>

            <div className="border-l-4 border-purple-600 pl-4">
              <h4 className="text-xl font-bold text-gray-900 mb-2">Cozy Companion</h4>
              <p className="text-gray-700">Low energy, novice, perfect for a calm companion.</p>
            </div>

            <div className="border-l-4 border-pink-600 pl-4">
              <h4 className="text-xl font-bold text-gray-900 mb-2">Social Butterfly</h4>
              <p className="text-gray-700">Very social and loves outgoing, friendly pets.</p>
            </div>

            <div className="border-l-4 border-green-600 pl-4">
              <h4 className="text-xl font-bold text-gray-900 mb-2">Quiet Caretaker</h4>
              <p className="text-gray-700">Reserved and ideal for shy or independent pets.</p>
            </div>

            <div className="border-l-4 border-red-600 pl-4">
              <h4 className="text-xl font-bold text-gray-900 mb-2">Confident Guardian</h4>
              <p className="text-gray-700">Experienced and well-suited for large or protective breeds.</p>
            </div>

            <div className="border-l-4 border-yellow-600 pl-4">
              <h4 className="text-xl font-bold text-gray-900 mb-2">Gentle Nurturer</h4>
              <p className="text-gray-700">Empathetic and perfect for special needs or timid pets.</p>
            </div>

            <div className="border-l-4 border-orange-600 pl-4">
              <h4 className="text-xl font-bold text-gray-900 mb-2">Playful Enthusiast</h4>
              <p className="text-gray-700">High energy and loves young, playful pets.</p>
            </div>

            <div className="border-l-4 border-indigo-600 pl-4">
              <h4 className="text-xl font-bold text-gray-900 mb-2">Balanced Buddy</h4>
              <p className="text-gray-700">Adaptable and matches well with most average pets.</p>
            </div>
          </div>
        </section>
